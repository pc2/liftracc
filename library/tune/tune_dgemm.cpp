...
#endif /* _LIFTRACC_PROFILING_ */
        liftracc_dgemm(liftracc_col_major, liftracc_no_trans, liftracc_no_trans,
                      p, p, p,
                      dAlpha, dA, p,
                      dB, p,
                      dBeta, dC, p);
...
#ifdef _LIFTRACC_PROFILING_
    print_profiling_data("tune_dgemm_result", &(liftracc_profiling_data[0]), prof_id_names, ID_COUNT);
    print_profiling_data("tune_dgemm_result", &(data[0]), 0, max_exp+1);
#endif /* _LIFTRACC_PROFILING_ */
