...
#endif /* _LIFTRACC_PROFILING_ */
        liftracc_daxpy(p, alpha, dA, 1, dB, 1);
#ifdef _LIFTRACC_PROFILING_        
...
#ifdef _LIFTRACC_PROFILING_
    print_profiling_data("tune_daxpy_result", &(liftracc_profiling_data[0]), prof_id_names, ID_COUNT);
    print_profiling_data("tune_daxpy_result", &(data[0]), 0, max_exp+1);
#endif /* _LIFTRACC_PROFILING_ */
