...
*/
    ...
    // function init
    double (*goto2_ddot)(const int n, const double *x, const int incx, const double *y, const int incy);

    *(void **) (&goto2_ddot) = dlsym(goto2_handle, "cblas_ddot");
...
#endif /* _LIFTRACC_PROFILING_ */
        double ret = (*goto2_ddot)(p, dA, 1, dB, 1);
#ifdef _LIFTRACC_PROFILING_        
...
#ifdef _LIFTRACC_PROFILING_        
    print_profiling_data("goto2_ddot_result", &(liftracc_profiling_data[0]), prof_id_names, ID_COUNT);
    print_profiling_data("goto2_ddot_result", &(data[0]), 0, max_exp+1);
#endif /* _LIFTRACC_PROFILING_ */
